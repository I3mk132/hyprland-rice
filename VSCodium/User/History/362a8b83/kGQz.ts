...
export const businessHours = pgTable("business_hours", {
  id: varchar("id", { length: 128 }).notNull().primaryKey(),
  mondayStatus: operatingStatusEnum("monday_status").notNull().default("otwarte"),
  tuesdayStatus: operatingStatusEnum("tuesday_status").notNull().default("otwarte"),
  wednesdayStatus: operatingStatusEnum("wednesday_status").notNull().default("otwarte"),
  thursdayStatus: operatingStatusEnum("thursday_status").notNull().default("otwarte"),
  fridayStatus: operatingStatusEnum("friday_status").notNull().default("otwarte"),
  saturdayStatus: operatingStatusEnum("saturday_status").notNull().default("otwarte"),
  sundayStatus: operatingStatusEnum("sunday_status").notNull().default("zamknięte"),
  mondayOpening: varchar("monday_opening", { length: 5 }).notNull(),
  tuesdayOpening: varchar("tuesday_opening", { length: 5 }).notNull(),
  wednesdayOpening: varchar("wednesday_opening", { length: 5 }).notNull(),
  thursdayOpening: varchar("thursday_opening", { length: 5 }).notNull(),
  fridayOpening: varchar("friday_opening", { length: 5 }).notNull(),
  saturdayOpening: varchar("saturday_opening", { length: 5 }).notNull(),
  sundayOpening: varchar("sunday_opening", { length: 5 }).notNull(),
  mondayClosing: varchar("monday_closing", { length: 5 }).notNull(),
  tuesdayClosing: varchar("tuesday_closing", { length: 5 }).notNull(),
  wednesdayClosing: varchar("wednesday_closing", { length: 5 }).notNull(),
  thursdayClosing: varchar("thursday_closing", { length: 5 }).notNull(),
  fridayClosing: varchar("friday_closing", { length: 5 }).notNull(),
  saturdayClosing: varchar("saturday_closing", { length: 5 }).notNull(),
  sundayClosing: varchar("sunday_closing", { length: 5 }).notNull(),
  createdAt: timestamp("created_at", { mode: "date" }).defaultNow().notNull(),
  updatedAt: timestamp("updated_at", { mode: "date" }).default(
    sql`current_timestamp`
  ),
