...
def solve_captcha(driver):
    ...
    captcha_element = driver.find_element(By.ID, "imgCaptchaImg") # تأكد من الـ ID من الـ Inspect Element
...
def check_obs():
    ...
    try:
        ...
        driver.find_element(By.ID, "txtParamT01").send_keys(USERNAME) # حقل اسم المستخدم
        driver.find_element(By.ID, "txtParamT02").send_keys(PASSWORD) # حقل كلمة المرور
        ...
        driver.find_element(By.ID, "txtSecCode").send_keys(captcha_solution) # حقل حل الكابتشا
