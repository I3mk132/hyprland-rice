...
def solve_captcha(driver):
    try:
        # انتظر ثانيتين للتأكد من تحميل عنصر الصورة بالكامل في الموقع
        time.sleep(5) 
        
        captcha_element = driver.find_element(By.ID, "imgCaptchaImg")
        
        # حفظ الصورة في المجلد الحالي للمشروع للتأكد منها
        captcha_element.screenshot("captcha.png")
        print("[+] تم التقاط صورة الكابتشا وحفظها كـ captcha.png")
